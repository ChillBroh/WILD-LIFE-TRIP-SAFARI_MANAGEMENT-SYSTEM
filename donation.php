    ...
    <div class="bodypart">
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            <div class="donForm">
                ...
                <p> Here is a great Opportunity for you to Donate funds for Wildlife maintanance and Expenses. <br> You can Donate funds without Registering to the system. This Opportunity is offered only by Wildlife Quest.</p>
                <br>
