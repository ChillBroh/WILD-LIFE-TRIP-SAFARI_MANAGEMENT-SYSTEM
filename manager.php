...
<body>
    ...
    <div class="admin-container">
        ...
        <div class="adm-col ac2">
            ...
            <div class="divider"></div>
            <a href="#">
                <div class="partition">Admins and Tour Guids<i style="margin-left: 20px;" class="fa-solid fa-rectangle-list"></i></div>
            </a>
            ...
            <div class="partition">Manage Admins<i style="margin-left: 20px;" class="fa-solid fa-address-card"></i></div>
