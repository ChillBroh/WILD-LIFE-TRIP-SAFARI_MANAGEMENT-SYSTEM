    ...
    <div class="user-card">
        <div class="user-col" id="ucol1">
            <div class="credits">
                ...
                <div class="submit-btn">Log-Out</div>
            </div>
        ...
        <div class="part p1">
          ...
          <div class="partition">Change Password</div>
            ...
            <div class="validate">
                <p class="val-correct"> Mismatch found while validating. <i class="fa-solid fa-circle-xmark"></i></i></p>
                <p class="val-wrong"> No mismatch found while validating. <i class="fa-solid fa-circle-check"></i></p>
                <p class="val-empty"> Please fill the textbox. <i class="fa-solid fa-unlock-keyhole"></i></p>
                <p class="val-fallback"> Something went wrong please check. <i class="fa-solid fa-arrows-rotate"></i></p>
            </div>
