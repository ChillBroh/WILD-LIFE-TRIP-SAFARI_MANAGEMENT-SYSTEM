...
<body>
    ...
    <div class="admin-container">
        <div class="adm-col ac1">
            <div class="credits">
                <?php if (isset($_SESSION['user_ID'])) {
                    ...
                    echo "<div class=\"user\">Tour Guide</div>";
                }
        ...
        <div class="adm-col ac2">
            <div class="user-type">Tour Guide</div>
            <div class="divider"></div>
            <div class="partition">Reservation Request <i style="margin-left: 20px;" class="fa-solid fa-rectangle-list"></i></div>
