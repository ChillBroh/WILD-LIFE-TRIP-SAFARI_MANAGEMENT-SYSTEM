...
<html lang="en">
  ...
  <body>
    ...
    <div class="cForm">
      ...
      <!-- <table class="cDetails">
        <tr>
          ...
          <td>
            <h3><i class="fa fa-phone" aria-hidden="true"></i> Telephone</h3>
      ...
      <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" >
        ...
        <input class="contact-form-phone"
          type="phone"
          name="phone"
          id="telephone"
        ...
        <textarea class="contact-form-txt"
          name="description"
          id="inquire"
          cols="92"
          rows="10"
    ...
    if(isset($_POST["subBtn"])){
      ...
      $sql= "INSERT INTO inquiree_phone(phone_no) VALUES('$pNo')";
      $sql1= "INSERT INTO inquires(date,Inquiry) VALUES('$date', '$inquire')";

      if(($con->query($sql)) && ($con->query($sql1))){

        /* Inquiree Send Successfully message */
          echo "<script>alert('You have successfully send a inquiree.!')</script>";
      }
